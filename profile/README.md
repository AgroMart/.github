...
*   🔀 **[api-dicionario](https://github.com/AgroMart/api-dicionario)**: API de roteamento criada para permitir a descentralização. Como cada CSA possui seu próprio servidor isolado, esta API armazena as URLs base (endpoints) de todas as CSAs e aponta o aplicativo do usuário para o servidor correto.
